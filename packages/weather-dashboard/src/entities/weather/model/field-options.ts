...
export const datasetFieldOptions: Record<WeatherDataset, WeatherFieldOption[]> = {
  raw: [
    { key: 'airtemperature', label: 'Temperature', color: '#dc6b3c', unitLabel: 'degrees centigrade' },
    { key: 'relativehumidity', label: 'Humidity', color: '#2e7ba2', unitLabel: 'percent' },
    { key: 'pressure', label: 'Pressure', color: '#3d5567', unitLabel: 'millibars' },
    { key: 'windavg', label: 'Wind Avg', color: '#4f8f56', unitLabel: 'metres per second' },
    { key: 'windgust', label: 'Wind Gust', color: '#1f5c3f', unitLabel: 'metres per second' },
    { key: 'uv', label: 'UV', color: '#d0a62f', unitLabel: 'UV index' },
    { key: 'solarradiation', label: 'Solar Radiation', color: '#bb6e1f', unitLabel: 'watts per square metre' },
    { key: 'rainaccumulation', label: 'Rain', color: '#4c67b0', unitLabel: 'millimetres' },
  ],
  refined: [
